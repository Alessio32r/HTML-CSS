...
const celsiusDegrees = Number.parseFloat(prompt(`Введите температуру в градусах Цельсия: `));
alert(`Округлённая температуру в градусах по Фаренгейту равена ${Math.floor((9 / 5) * celsiusDegrees + 32)}`);